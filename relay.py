...
import numpy as np
import datetime
import pytz  # Python library for handling time zones

# Parameters
video_source = 0  # Use 0 for the default camera, or specify a video file path
...
while True:
    ...
    cv2.putText(frame, timestamp, (frame.shape[1] - 300, frame.shape[0] - 10),
